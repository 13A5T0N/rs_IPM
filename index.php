...
<br>
           <div id="buttonr"class="col-sm-12" style="text-align:center">      
              ...
              <form action="../rs_IPM/student/backend/loginpin.php" method="post" autocomplete="off">
...
<div class="col-md-12">
 ...
 <!-- form scan -->
      <form action="../rs_IPM/student/backend/login.php" method="POST" id="myForm">
...
<!-- cam script -->
    <script src="../rs_IPM/student/qrcode/js/jquery-3.4.1.min.js"></script>
    <script src="../rs_IPM/student/qrcode/scanner/vendor/modernizr/modernizr.js"></script>
    <script src="../rs_IPM/student/qrcode/scanner/vendor/vue/vue.min.js"></script>
<!-- scanner -->
<script src="../rs_IPM/student/qrcode/scanner/js/app.js"></script>
<script src="../rs_IPM/student/qrcode/scanner/vendor/instascan/instascan.min.js"></script>
<script src="../rs_IPM/student/qrcode/scanner/js/scanner.js"></script>
<script src="../rs_IPM/student/qrcode/scanner/js/scanner.js"></script>
